...
## 36. Proposed approval statement
...
[^trl]: Hugging Face, TRL documentation. TRL provides SFT, DPO, SimPO-related preference tooling and other offline and online post-training trainers integrated with Transformers: <https://huggingface.co/docs/trl/index>.

[^peft]: Hugging Face, PEFT FSDP documentation. PEFT supports parameter-efficient adapters together with FSDP through Accelerate: <https://huggingface.co/docs/peft/accelerate/fsdp>.
...
[^lambda-api]: Lambda Cloud API documentation. Lambda publishes API endpoints for instance and filesystem lifecycle management: <https://docs.lambda.ai/api/cloud>.

[^lambda-billing]: Lambda, “Billing.” On-demand instances are billed while running until provider-side termination; filesystems are separately billed while they exist: <https://docs.lambda.ai/public-cloud/billing/>.

[^lambda-filesystems]: Lambda, “Filesystems.” Lambda filesystems are regional persistent stores attached to instances and are separate from instance-local scratch: <https://docs.lambda.ai/public-cloud/filesystems/>.

[^lambda-lifecycle]: Lambda, “Creating and managing instances.” Provider-side lifecycle management and termination—not an operating-system shutdown—govern instance state and billing: <https://docs.lambda.ai/public-cloud/on-demand/creating-managing-instances/>.
