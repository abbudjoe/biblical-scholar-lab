...
[^crossref-nexus]: Crossref, “The Research Nexus.” Crossref describes a network connecting research works, versions, translations, corrections, contributors, organisations, data, software, grants, and other relationships: https://www.crossref.org/documentation/research-nexus/

[^crossref-metadata]: Crossref, “Metadata Retrieval.” Crossref documents that its metadata comes primarily from member deposits, internal enrichment, and selected external sources; almost all metadata is open, while abstracts may remain copyrighted: https://www.crossref.org/documentation/retrieve-metadata/

[^crossref-crossmark]: Crossref, “Crossmark.” Crossmark exposes current publication status and update metadata such as corrections and retractions: https://crossref.org/documentation/crossmark/

[^crossref-versioning]: Crossref, “Version control, corrections, and retractions.” Crossref distinguishes preprints, accepted manuscripts, versions of record, and editorially significant updates: https://www.crossref.org/documentation/principles-practices/best-practices/versioning

[^crossref-retraction-watch]: Crossref, “Retraction Watch.” Retraction Watch updates are available through the Crossref REST API and a regularly updated dataset with source attribution: https://www.crossref.org/documentation/retrieve-metadata/retraction-watch/

[^datacite-relations]: DataCite, “Connecting to Works.” DataCite uses typed related identifiers for citations, versions, parts, supplements, and other research-object relationships: https://support.datacite.org/docs/connecting-to-works

[^datacite-versioning]: DataCite, “Versioning.” DataCite distinguishes minor updates from major versions and recommends relations among separately identified versions: https://support.datacite.org/docs/versioning

[^datacite-translations]: DataCite, “How can I represent resources that have been translated into different languages?” DataCite supports translation relationships and translator contribution roles: https://support.datacite.org/docs/how-can-i-represent-resources-that-have-been-translated-into-different-languages-using-the-datacite-metadata-schema

[^orcid-trust]: ORCID, “ORCID Trust.” ORCID records preserve the source and date of assertions and use a distributed trust model for work and affiliation connections: https://info.orcid.org/orcid-trust/

[^orcid-source]: ORCID, “What does ‘Source’ mean in an ORCID record?” ORCID distinguishes the system that added an assertion from the assertion origin: https://info.orcid.org/ufaqs/what-does-source-mean-in-an-orcid-record/

[^ror]: Research Organization Registry, “About.” ROR provides open, persistent, CC0 identifiers and metadata for research organisations and is integrated with Crossref, DataCite, and ORCID: https://ror.org/about/

[^peer-review]: NISO, ANSI/NISO Z39.106-2023, *Standard Terminology for Peer Review*. The standard defines terminology for transparent communication of peer-review processes: https://www.niso.org/publications/z39106-2023-peerreview

[^credit]: NISO, CRediT Contributor Role Taxonomy. CRediT provides fourteen structured contributor roles but does not itself determine authorship: https://credit.niso.org/

[^jats]: NISO/NLM, JATS 1.4. JATS provides structured XML models for journal metadata and full-text content and was approved as ANSI/NISO Z39.96-2024: https://jats.nlm.nih.gov/

[^csl]: Citation Style Language, “CSL 1.0.2 Specification.” CSL is an open, localized format for rendering citations and bibliographies: https://docs.citationstyles.org/en/v1.0.2/specification.html

[^doaj]: DOAJ, COPE, OASPA, and WAME, “Principles of Transparency and Best Practice in Scholarly Publishing.” The principles require transparent peer-review, access, licensing, editorial, and ethics policies: https://doaj.org/apply/transparency/

[^unpaywall]: Unpaywall, “REST API.” Unpaywall exposes DOI-level open-access locations and version information for discovery of lawful accessible copies: https://data.unpaywall.org/products/api

[^cope-transparency]: COPE, DOAJ, OASPA, and WAME, “Principles of Transparency and Best Practice in Scholarly Publishing”: https://doi.org/10.24318/cope.2019.1.12
