...
- `DR-18` — Training Curriculum and Objectives, including no-training baselines, distinct product-first and clean-Base lineages, staged ancient/context CPT, structured Translation Nuance mid-training, scholarly and retrieval-aware SFT, explicit replay and capability-preservation plans, matched preference ablations, immutable checkpoints and exposure records, multi-objective promotion gates, and budget released only through owner-approved experiments
